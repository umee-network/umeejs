    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.exchangeRates.push(DenomExchangeRate.decode(reader, reader.uint32()));
          break;
        case 4:
        ...
        case 7:
          ...
          break;
        case 8:
          message.historicPrices.push(Price.decode(reader, reader.uint32()));
          break;
        case 9:
          message.medianDeviations.push(Price.decode(reader, reader.uint32()));
          break;
        case 10:
          message.avgCounterParams = AvgCounterParams.decode(reader, reader.uint32());
          break;
        default:
...
export const Price = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Price {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.exchangeRateTuple = ExchangeRateTuple.decode(reader, reader.uint32());
          break;
        case 2:
