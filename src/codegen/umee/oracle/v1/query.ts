...
export const QueryMissCounters = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryMissCounters {
...
export const QueryMissCountersResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryMissCountersResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.missCounters.push(PriceMissCounter.decode(reader, reader.uint32()));
          break;
        default:
          reader.skipType(tag & 7);
          break;
...
export const PriceMissCounter = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PriceMissCounter {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryExgRatesWithTimestamp = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryExgRatesWithTimestamp {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryExgRatesWithTimestampResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryExgRatesWithTimestampResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.exgRates.push(DenomExchangeRate.decode(reader, reader.uint32()));
          break;
        default:
          reader.skipType(tag & 7);
          break;
...
export const QueryMediansResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryMediansResponse {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.medians.push(Price.decode(reader, reader.uint32()));
          break;
        default:
          reader.skipType(tag & 7);
          break;
...
export const QueryMedianDeviationsResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryMedianDeviationsResponse {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.medianDeviations.push(Price.decode(reader, reader.uint32()));
          break;
        default:
          reader.skipType(tag & 7);
          break;
...
export const QueryAvgPrice = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryAvgPrice {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryAvgPriceResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryAvgPriceResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
