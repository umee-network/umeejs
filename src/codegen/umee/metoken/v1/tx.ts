    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.returned = Coin.decode(reader, reader.uint32());
          break;
        default:
          reader.skipType(tag & 7);
          break;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.metoken = Coin.decode(reader, reader.uint32());
          break;
        case 3:
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.addIndex.push(Index.decode(reader, reader.uint32()));
          break;
        case 3:
          message.updateIndex.push(Index.decode(reader, reader.uint32()));
          break;
        default:
          reader.skipType(tag & 7);
          break;
