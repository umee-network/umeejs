...
export const Params = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Params {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.rebalancingFrequency = reader.int64();
          break;
        case 2:
          message.claimingFrequency = reader.int64();
          break;
        default:
  ...
  toAmino(message: Params): ParamsAmino {
    const obj: any = {};
    obj.rebalancing_frequency = message.rebalancingFrequency ? message.rebalancingFrequency.toString() : undefined;
    obj.claiming_frequency = message.claimingFrequency ? message.claimingFrequency.toString() : undefined;
    return obj;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          break;
        case 5:
          message.acceptedAssets.push(AcceptedAsset.decode(reader, reader.uint32()));
          break;
        default:
          reader.skipType(tag & 7);
          break;
...
export const Fee = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Fee {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.minFee = Decimal.fromAtomics(reader.string(), 18).toString();
          break;
        case 2:
          message.balancedFee = Decimal.fromAtomics(reader.string(), 18).toString();
          break;
        case 3:
          message.maxFee = Decimal.fromAtomics(reader.string(), 18).toString();
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  toAmino(message: Fee): FeeAmino {
    ...
    obj.balanced_fee = message.balancedFee;
...
export const AcceptedAsset = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AcceptedAsset {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.reservePortion = Decimal.fromAtomics(reader.string(), 18).toString();
          break;
        case 3:
          message.targetAllocation = Decimal.fromAtomics(reader.string(), 18).toString();
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  toAmino(message: AcceptedAsset): AcceptedAssetAmino {
    const obj: any = {};
    obj.denom = message.denom;
    obj.reserve_portion = message.reservePortion;
    obj.target_allocation = message.targetAllocation;
    return obj;
  },
...
export const IndexPrices = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): IndexPrices {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 4:
          message.assets.push(AssetPrice.decode(reader, reader.uint32()));
          break;
        default:
          reader.skipType(tag & 7);
          break;
...
export const AssetPrice = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          break;
        case 5:
          message.swapRate = Decimal.fromAtomics(reader.string(), 18).toString();
          break;
        case 6:
          message.redeemRate = Decimal.fromAtomics(reader.string(), 18).toString();
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  toAmino(message: AssetPrice): AssetPriceAmino {
    ...
    obj.price = message.price;
    obj.exponent = message.exponent;
    obj.swap_rate = message.swapRate;
    obj.redeem_rate = message.redeemRate;
    return obj;
  },
