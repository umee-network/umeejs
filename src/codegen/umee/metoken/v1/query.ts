...
export const QueryIndexes = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryIndexes {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.metokenDenom = reader.string();
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  toAmino(message: QueryIndexes): QueryIndexesAmino {
    const obj: any = {};
    obj.metoken_denom = message.metokenDenom;
    return obj;
  },
...
export const QueryIndexesResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryIndexesResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QuerySwapFee = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QuerySwapFee {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QuerySwapFeeResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QuerySwapFeeResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryRedeemFee = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryRedeemFee {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryRedeemFeeResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryRedeemFeeResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryIndexBalances = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryIndexBalances {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryIndexBalancesResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryIndexBalancesResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.indexBalances.push(IndexBalances.decode(reader, reader.uint32()));
          break;
        case 2:
          message.prices.push(IndexPrices.decode(reader, reader.uint32()));
          break;
        default:
          reader.skipType(tag & 7);
          break;
...
export const QueryIndexPrices = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryIndexPrices {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryIndexPricesResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryIndexPricesResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
