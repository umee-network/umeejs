...
export const MsgMaxWithdraw = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgMaxWithdraw {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgMaxBorrow = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgMaxBorrow {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgLeveragedLiquidate = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgLeveragedLiquidate {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toAmino(message: MsgLeveragedLiquidate): MsgLeveragedLiquidateAmino {
    ...
    obj.reward_denom = message.rewardDenom;
    obj.max_repay = message.maxRepay;
    return obj;
  },
...
export const MsgSupplyCollateral = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgSupplyCollateral {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgMaxWithdrawResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgMaxWithdrawResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgMaxBorrowResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgMaxBorrowResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgLeveragedLiquidateResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgLeveragedLiquidateResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgSupplyCollateralResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgSupplyCollateralResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgGovUpdateRegistry = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgGovUpdateRegistry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 4:
          message.addTokens.push(Token.decode(reader, reader.uint32()));
          break;
        case 5:
          message.updateTokens.push(Token.decode(reader, reader.uint32()));
          break;
        default:
          reader.skipType(tag & 7);
          break;
...
export const MsgGovUpdateRegistryResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgGovUpdateRegistryResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgGovUpdateSpecialAssets = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgGovUpdateSpecialAssets {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.sets.push(SpecialAssetSet.decode(reader, reader.uint32()));
          break;
        case 4:
...
export const MsgGovUpdateSpecialAssetsResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgGovUpdateSpecialAssetsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgGovSetParams = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgGovSetParams {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgGovSetParamsResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgGovSetParamsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
