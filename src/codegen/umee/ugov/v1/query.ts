...
export const QueryMinGasPrice = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryMinGasPrice {
...
export const QueryEmergencyGroup = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryEmergencyGroup {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryEmergencyGroupResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryEmergencyGroupResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryInflationParams = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryInflationParams {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryInflationParamsResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryInflationParamsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryInflationCycleEnd = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryInflationCycleEnd {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryInflationCycleEndResponse = {
  ...
  encode(message: QueryInflationCycleEndResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.end !== undefined) {
      Timestamp.encode(toTimestamp(message.end), writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },
  decode(input: BinaryReader | Uint8Array, length?: number): QueryInflationCycleEndResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
