...
export const MsgGovUpdateMinGasPrice = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgGovUpdateMinGasPrice {
...
export const MsgGovUpdateMinGasPriceResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgGovUpdateMinGasPriceResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgGovSetEmergencyGroup = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgGovSetEmergencyGroup {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgGovSetEmergencyGroupResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgGovSetEmergencyGroupResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgGovUpdateInflationParams = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgGovUpdateInflationParams {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GovUpdateInflationParamsResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GovUpdateInflationParamsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
