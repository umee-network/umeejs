...
export const Params = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.totalQuota = Decimal.fromAtomics(reader.string(), 18).toString();
          break;
        case 3:
          message.tokenQuota = Decimal.fromAtomics(reader.string(), 18).toString();
          break;
        case 4:
          message.quotaDuration = Duration.decode(reader, reader.uint32());
          break;
        case 5:
          message.inflowOutflowQuotaBase = Decimal.fromAtomics(reader.string(), 18).toString();
          break;
        case 6:
          message.inflowOutflowQuotaRate = Decimal.fromAtomics(reader.string(), 18).toString();
          break;
        case 7:
          message.inflowOutflowTokenQuotaBase = Decimal.fromAtomics(reader.string(), 18).toString();
          break;
        default:
  ...
  toAmino(message: Params): ParamsAmino {
    ...
    obj.inflow_outflow_quota_base = message.inflowOutflowQuotaBase;
    obj.inflow_outflow_quota_rate = message.inflowOutflowQuotaRate;
    obj.inflow_outflow_token_quota_base = message.inflowOutflowTokenQuotaBase;
    return obj;
  },
