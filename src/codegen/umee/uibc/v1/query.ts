...
export const QueryQuotaExpires = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryQuotaExpires {
...
export const QueryQuotaExpiresResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryQuotaExpiresResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryInflows = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryInflows {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryInflowsResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryInflowsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryOutflows = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryOutflows {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryAllOutflows = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryAllOutflows {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryAllOutflowsResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryAllOutflowsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
