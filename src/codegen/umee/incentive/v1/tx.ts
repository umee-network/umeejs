...
export const MsgBeginUnbonding = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgBeginUnbonding {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgBeginUnbondingResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgBeginUnbondingResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgEmergencyUnbond = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgEmergencyUnbond {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgEmergencyUnbondResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgEmergencyUnbondResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgSponsor = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgSponsor {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgSponsorResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgSponsorResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgGovCreatePrograms = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgGovCreatePrograms {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.fromCommunityFund = reader.bool();
          break;
        default:
          reader.skipType(tag & 7);
          break;
...
export const MsgGovCreateProgramsResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgGovCreateProgramsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
