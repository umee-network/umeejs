    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.nextProgramId = reader.uint32();
          break;
        case 3:
          message.lastRewardsTime = reader.int64();
          break;
        case 4:
          message.rewardTrackers.push(RewardTracker.decode(reader, reader.uint32()));
          break;
        case 5:
          message.rewardAccumulators.push(RewardAccumulator.decode(reader, reader.uint32()));
          break;
        case 6:
          message.upcomingPrograms.push(IncentiveProgram.decode(reader, reader.uint32()));
          break;
        case 7:
          message.ongoingPrograms.push(IncentiveProgram.decode(reader, reader.uint32()));
          break;
        case 8:
          message.completedPrograms.push(IncentiveProgram.decode(reader, reader.uint32()));
          break;
        case 9:
          message.bonds.push(Bond.decode(reader, reader.uint32()));
          break;
        case 10:
          message.accountUnbondings.push(AccountUnbondings.decode(reader, reader.uint32()));
          break;
        default:
...
export const RewardTracker = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RewardTracker {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RewardAccumulator = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RewardAccumulator {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const AccountUnbondings = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AccountUnbondings {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
