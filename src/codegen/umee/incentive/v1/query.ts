...
export const QueryPendingRewards = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryPendingRewards {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryPendingRewardsResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryPendingRewardsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryAccountBonds = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryAccountBonds {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryAccountBondsResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryAccountBondsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.bonded.push(Coin.decode(reader, reader.uint32()));
          break;
        case 2:
          message.unbonding.push(Coin.decode(reader, reader.uint32()));
          break;
        case 3:
...
export const QueryTotalBonded = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryTotalBonded {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryTotalBondedResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryTotalBondedResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryTotalUnbonding = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryTotalUnbonding {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryTotalUnbondingResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryTotalUnbondingResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryUpcomingIncentivePrograms = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryUpcomingIncentivePrograms {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryUpcomingIncentiveProgramsResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryUpcomingIncentiveProgramsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.programs.push(IncentiveProgram.decode(reader, reader.uint32()));
          break;
        default:
          reader.skipType(tag & 7);
          break;
...
export const QueryOngoingIncentivePrograms = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryOngoingIncentivePrograms {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryOngoingIncentiveProgramsResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryOngoingIncentiveProgramsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryCompletedIncentivePrograms = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryCompletedIncentivePrograms {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryCompletedIncentiveProgramsResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryCompletedIncentiveProgramsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryIncentiveProgram = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryIncentiveProgram {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryIncentiveProgramResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryIncentiveProgramResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.program = IncentiveProgram.decode(reader, reader.uint32());
          break;
        default:
          reader.skipType(tag & 7);
          break;
...
export const QueryCurrentRates = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryCurrentRates {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryCurrentRatesResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryCurrentRatesResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.referenceBond = Coin.decode(reader, reader.uint32());
          break;
        case 2:
          message.rewards.push(Coin.decode(reader, reader.uint32()));
          break;
...
export const QueryLastRewardTime = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryLastRewardTime {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryLastRewardTimeResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryLastRewardTimeResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryActualRates = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryActualRates {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryActualRatesResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryActualRatesResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.APY = Decimal.fromAtomics(reader.string(), 18).toString();
          break;
        default:
          reader.skipType(tag & 7);
          break;
